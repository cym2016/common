...
public class FetchRouteMessage {
	...
	public static ChannelRouteMessage getRouteChannelMesage(String info){
		...
		try {
			...
			channleRouteMsg.setChannelPartnerName(map.get("channelPartnerName")); // 通道合作方
			channleRouteMsg.setChannelPartnerCode(map.get("channelPartnerCode")); // 通道合作方代码
			...
			channleRouteMsg.setEffectEndDate(DateUtils.getStr2Date(map.get("effectEndDate"))); // 有效开始时间
			channleRouteMsg.setEffectStartDate(DateUtils.getStr2Date(map.get("effectStartDate"))); // 有效开始时间
			...
			channleRouteMsg.setContractDate(DateUtils.getStr2Date(map.get("contractDate"))); // 合约时间
