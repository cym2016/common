...
public class JsonMapperUtil {
	...
	private static JsonMapperUtil jsonMapperUtil = new JsonMapperUtil(Include.NON_EMPTY);
	 ...
	 * @return
	 */
	public String getKeyValue(String jsonStr,String key){
		String nodeName=null;
		try {
			JsonNode jsonNode = mapper.readTree(jsonStr);
			nodeName = jsonNode.get(key).toString();
		} catch (IOException e) {
			e.printStackTrace();
		}
		return nodeName;
